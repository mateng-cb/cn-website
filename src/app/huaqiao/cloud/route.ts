import { HQ_CLOUD_PAGE_HTML } from '@/lib/hq-static/cloud';
import { withFavicon } from '@/lib/hq-static/head';
import { SITE_URL } from '@/lib/site-url';

/**
 * /huaqiao/cloud 静态单文件页（2026-09 新版二级页）。
 * 分工：CMS 的 Page 条目（site=hq, slug=cloud）承载页面级信息——后台可见、
...
export function GET() {
  ...
  return new Response(withFavicon(HQ_CLOUD_PAGE_HTML.replaceAll('__SITE_URL__', SITE_URL)), {
